...
void modificarProducto(struct Producto inventario[], int n);  // CORREGIDO: agregado al prototipo correctamente
void ordenarProductos(struct Producto inventario[], int n);   // NUEVO: función separada para ordenar
...
int main()
{
  ...
  // CORREGIDO: usa la función ordenarProductos en lugar de repetir el Bubble Sort
...
// NUEVO: función separada para ordenar por nroProducto (Bubble Sort)
...
// CORREGIDO: modificarProducto ahora funciona correctamente
void modificarProducto(struct Producto inventario[], int n)
{
  ...
  // Busca el producto directamente en el arreglo por su número
  for (int i = 0; i < n; i++)
  {
